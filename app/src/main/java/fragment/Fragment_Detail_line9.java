...
public class Fragment_Detail_line9 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        curSt.setBackgroundResource(R.drawable.station9_main);
        ...
        next_btn.setBackgroundResource(R.drawable.station9_sub);
        ...
        back_Btn.setBackgroundResource(R.drawable.station9_sub);
    ...
    public void setArrivalRealTime(){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    String URL = "https://m.search.naver.com/search.naver?sm=tab_hty.top&where=m&query="+curStation+"9호선";
    ...
    public void setUPArrivalTime(){
        ...
        Bundle curstation = getArguments();
        if(curstation != null){
            curStation = curstation.getString("station")+9;
        }
