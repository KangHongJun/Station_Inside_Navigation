...
public class Fragment_Detail_line extends Fragment {
    private String curStation_line;
    private static String curStation;
    Cursor cursor_code;
  
  public class Fragment_Detail_line(String curStation_line) {
    this.curStation_line = curStation_line;
  }
