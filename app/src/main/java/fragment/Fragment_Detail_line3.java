...
public class Fragment_Detail_line3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        curSt.setBackgroundResource(R.drawable.station3_main);
        ...
        //현재역 code 얻기
        sqlCode = "select CODE from subway_line where NAME = " +"\""+ curStation +"\""+"and line=3";
        ...
        next_btn.setBackgroundResource(R.drawable.station3_sub);
        ...
        back_Btn.setBackgroundResource(R.drawable.station3_sub);
    ...
    public void setArrivalRealTime(){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    String URL = "https://m.search.naver.com/search.naver?sm=tab_hty.top&where=m&query="+curStation+"3호선";
    ...
    public void setUPArrivalTime(){
        ...
        Bundle curstation = getArguments();
        if(curstation != null){
            curStation = curstation.getString("station")+3;
        }
