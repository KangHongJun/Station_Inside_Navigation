...
public class Fragment_Detail_line2 extends Fragment {
    ...
    public void setArrivalRealTime(){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    String URL = "https://m.search.naver.com/search.naver?sm=tab_hty.top&where=m&query="+curStation+"2호선";
    ...
    public void setUPArrivalTime(){
        ...
        Bundle curstation = getArguments();
        if(curstation != null){
            curStation = curstation.getString("station")+2;
        }
