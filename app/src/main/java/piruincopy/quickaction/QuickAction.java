...
//    public void addActionItem(final quickaction.ActionItem actions) {
...
//    }
    ...
    public void show(@NonNull View anchor, int xPos, int yPos) {
        if (getContext() == null)
            throw new IllegalStateException("Why context is null? It shouldn't be.");
        ...
        mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, 300,300);
    }
